 ...
 * (c) Pinecone, LLC
 *
 * Modified to keep only the tooltip handling
 * Foundation charges the content of the tooltips on the page load. To modify the content dynamically (with angularjs), tooltips have to be charged again. This file fixes it.
 */

angular.module("mm.foundation", ["mm.foundation.tpls","mm.foundation.bindHtml","mm.foundation.position","mm.foundation.tooltip"]);
